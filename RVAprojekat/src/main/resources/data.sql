...
values (nextval('usluga_seq'),1,1,'prenos sredstava',to_date('11.02.2024.','dd.mm.yyyy.'),'prenos sredstava na racun',15),
	  (nextval('usluga_seq'),2,2,'DVOJKA',to_date('11.02.2024.','dd.mm.yyyy.'),'prenos sredstava na racun',15),
      (nextval('usluga_seq'),3,3,'otvaranje racuna',to_date('01.03.2024.','dd.mm.yyyy.'),'otvaranje racuna klijentu',1),
      (nextval('usluga_seq'),4,4,'kredit',to_date('20.07.2024.','dd.mm.yyyy.'),'odobravanje kredita',50),
      (nextval('usluga_seq'),4,4,'dozvoljeni minus',to_date('24.09.2023.','dd.mm.yyyy.'),'odobravanje dozvoljenog minusa',55);